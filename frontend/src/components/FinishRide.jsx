...
const FinishRide = (props) => {
  ...
  return (
    <div className="w-[380px] h-[400px] pr-2">
      <h5
      ...
      <div className="flex items-center justify-between p-4 border-2 border-yellow-400 rounded-lg mt-4">
        ...
        <h5 className="text-gray-600 text-lg font-semibold">2.2 KM</h5>
      </div>
      <div className="flex gap-2 justify-between flex-col items-center">
        ...
        <div className="w-full">
          <button
            onClick={endRide}
            className="w-full mt-5 flex cursor-pointer text-lg justify-center bg-green-600 text-white font-semibold p-3 rounded-lg"
          >
            Finish Ride
          </button>
        </div>
