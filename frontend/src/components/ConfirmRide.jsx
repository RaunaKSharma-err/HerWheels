            ...
            <div className='flex gap-2 justify-between flex-col items-center'>
                ...
                <div className='w-full mt-5'>
                    ...
                    <div className='flex items-center gap-5 p-3'>
                        ...
                        <div>
                            <h3 className='text-lg font-medium text-gray-600'>₹{props.vehicletype}</h3>
                ...
                }} className='w-full mt-5 cursor-pointer bg-green-600 text-white font-semibold p-2 rounded-lg'>Confirm</button>
            </div>
        </div>
    )
}
